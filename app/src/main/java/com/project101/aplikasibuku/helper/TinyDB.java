...
public class TinyDB {
    ...
    public ArrayList<ModelBukuPopuler> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<ModelBukuPopuler> playerList =  new ArrayList<ModelBukuPopuler>();

    	for(String jObjString : objStrings){
    		ModelBukuPopuler player  = gson.fromJson(jObjString,  ModelBukuPopuler.class);
    ...
    public void putListObject(String key, ArrayList<ModelBukuPopuler> playerList){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objString = new ArrayList<String>();
    	for(ModelBukuPopuler player : playerList){
            objString.add(gson.toJson(player));
    	}
